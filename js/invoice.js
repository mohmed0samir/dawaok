...
function renderInvoice(data) {
  ...
  const bannerHTML = isRx ? `
    <div class="success-banner rx">
      ...
      <div class="success-text">
        ...
        <p>الصيدلي بيراجعها دلوقتي وهيتواصل معاك لتأكيد السعر والتوصيل</p>
      </div>
    </div>` : `
  ...
  const totalsHTML = isRx ? `
    <div class="inv-totals">
      <div class="inv-total-row"><span class="lbl">حالة التسعير</span><span class="amt">في انتظار مراجعة الصيدلي</span></div>
    </div>` : `
    <div class="inv-totals">
